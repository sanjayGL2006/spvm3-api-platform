...
sys.exec_prefix
   ...
   Changed in version 3.14: When running under a virtual environment,
...
sys.flags
   ...
   Changed in version 3.14: Added the "thread_inherit_context"
   attribute.

   Changed in version 3.14: Added the "context_aware_warnings"
   attribute.
...
sys.getrefcount(object)
   ...
   **CPython implementation detail:** *Immortal* objects with a large
   reference count can be identified via "_is_immortal()".
...
sys.getobjects(limit[, type])
   ...
   **CPython implementation detail:** This function should be used for
   ...
   Changed in version 3.14: The result may include objects from other
   interpreters.
...
sys.hash_info
   ...
   Changed in version 3.4: Added *algorithm*, *hash_bits*,
...
sys.implementation
   ...
   *supports_isolated_interpreters* is a boolean value, whether this
   ...
   See also: **PEP 684**, **PEP 734**, and "concurrent.interpreters".
   ...
   Changed in version 3.14: Added "supports_isolated_interpreters"
   field.
...
sys._jit
   ...
   **CPython implementation detail:** JIT compilation is an
...
sys.platform
   ...
   *at the time when Python was built*. Unless you want to test for a
   ...
   Changed in version 3.14: On FreeBSD, "sys.platform" doesn't contain
...
sys.settrace(tracefunc)
   ...
   *arg*. *frame* is the current stack frame. *event* is a string:
   ...
   "'line'"
      ...
      local trace function.  See InternalDocs/code_objects.md for a
