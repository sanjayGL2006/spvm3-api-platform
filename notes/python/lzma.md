...
"bz2" module. Note that "LZMAFile" and "bz2.BZ2File" are *not* thread-
safe, so if you need to use a single "LZMAFile" instance from multiple
...
lzma.MODE_NORMAL
   ...
   specifier (see Specifying custom filter chains).
