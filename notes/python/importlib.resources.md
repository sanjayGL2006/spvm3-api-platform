...
Warning:
  ...
  "importlib.resources" follows the same security model as the built-
  in "open()" function. Passing untrusted inputs to the functions in
  this module is unsafe.

Note:

  The standalone backport of this module provides more information on
  using importlib.resources and migrating from pkg_resources to
  importlib.resources.
