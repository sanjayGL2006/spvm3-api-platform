...
json.dumps(obj, *, skipkeys=False, ensure_ascii=True, check_circular=True, allow_nan=True, cls=None, indent=None, separators=None, default=None, sort_keys=False, **kw)
   ...
   Note:
     ...
     is, "loads(dumps(x)) != x" if x has non-string keys. *sort_keys*
     sorts the keys before they are coerced to strings, so numeric
     keys are sorted by value, not by their string representation.
...
Changed in version 3.14: The "json" module may now be directly
