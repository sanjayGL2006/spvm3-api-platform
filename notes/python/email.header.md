...
"Message" instance was flattened, the *Subject* field was properly
**RFC 2047** encoded.  MIME-aware mail readers would show this header
...
class email.header.Header(s=None, charset=None, maxlinelen=None, header_name=None, continuation_ws=' ', errors='strict')
   ...
   *continuation_ws* defaults to a single space character.
   ...
   __str__()
      ...
      specified encoding and joined together appropriately.  Any
      pieces with a charset of "'unknown-8bit'" are decoded as ASCII
