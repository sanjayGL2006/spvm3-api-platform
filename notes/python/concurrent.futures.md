...
class concurrent.futures.ProcessPoolExecutor(max_workers=None, mp_context=None, initializer=None, initargs=(), max_tasks_per_child=None)
   ...
   *mp_context* configured to use a different start method. See the
   ...
   Changed in version 3.14.7: Fixed a deadlock (gh-115634) where the
   executor could hang after a worker process exited upon reaching its
   *max_tasks_per_child* limit while tasks remained queued.
