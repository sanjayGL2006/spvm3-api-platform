...
Subclass relationships:
   ...
   [image: timedelta, tzinfo, time, and date inherit from object;
...
Changed in version 3.13: Comparison between "datetime" object and an
...
classmethod datetime.utcfromtimestamp(timestamp)
   ...
   Changed in version 3.15: Accepts any real number as *timestamp*,
...
datetime.timestamp()
   ...
   this method relies on platform C functions to perform the
   conversion. Since "datetime" supports a wider range of values than
   the platform C functions on many platforms, this method may raise
   ...
   Changed in version 3.6: This method no longer relies on the
   platform C "mktime()" function to perform conversions.
