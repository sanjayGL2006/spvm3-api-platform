...
class graphlib.TopologicalSorter(graph=None)
   ...
   * While "is_active()" is "True", iterate over the nodes returned by
     "get_ready()" and process them. Call "done()" on each node as it
     finishes processing.
   ...
   prepare()
      ...
      Changed in version 3.14: "prepare()" can now be called more than
      once as long as the sort has not started. Previously this raised
      "ValueError".
