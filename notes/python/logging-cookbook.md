...
Changed in version 3.14: The "QueueListener" can be started (and
...
should be adaptable to your specific needs. With the above handler,
...
Use the techniques outlined in Logging to a single file from multiple
processes to circumvent such issues.
