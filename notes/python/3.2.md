...
See also:
  ...
  **PEP 389** - New Command Line Parsing Module
  ...
  Migrating optparse code to argparse for details on the differences
  from "optparse".
...
* Struct sequence types are now subclasses of tuple. This means that C
  structures like those returned by "os.stat()", "time.gmtime()", and
  "sys.version_info" now work like a *named tuple* and now work with
  functions and methods that expect a tuple as an argument.  This is a
  big step forward in making the C structures as flexible as their
...
An early decision to limit the interoperability of various numeric
...
https://svn.python.org there is now a Mercurial repository at
https://hg.python.org/.
