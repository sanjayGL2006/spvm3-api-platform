...
sqlite3.enable_callback_tracebacks(flag, /)
   ...
   Note:
     ...
     Errors in user-defined function callbacks are logged as
     unraisable exceptions. Use an "unraisable hook handler" for
...
class sqlite3.Connection
   ...
   Changed in version 3.13: A "ResourceWarning" is emitted if
   ...
   set_progress_handler(progress_handler, n)
      ...
      *n* instructions of the SQLite virtual machine. This is useful
      ...
      Changed in version 3.13: Passing *progress_handler* as a keyword
   ...
   iterdump(*, filter=None)
      ...
      Parameters:
         **filter** (*str** | **None*) -- An optional "LIKE" pattern
         for database objects to dump, e.g. "prefix_%". If "None" (the
         default), all database objects will be included.
   ...
   row_factory
      ...
      Changed in version 3.14.6: Deleting the "row_factory" attribute
   ...
   text_factory
      ...
      Changed in version 3.14.6: Deleting the "text_factory" attribute
      is no longer allowed.
...
class sqlite3.Cursor
   ...
   execute(sql, parameters=(), /)
      ...
      *sql*.
      ...
      Changed in version 3.14: "ProgrammingError" is emitted if named
      placeholders are used and *parameters* is a sequence instead of
      a "dict".
   ...
   executemany(sql, parameters, /)
      ...
      *sql*.
      ...
      Changed in version 3.14: "ProgrammingError" is emitted if named
      placeholders are used and the items in *parameters* are
   ...
   fetchmany(size=cursor.arraysize)
      ...
      *size* parameter. For optimal performance, it is usually best to
      ...
      Changed in version 3.14.1: Negative *size* values are rejected
   ...
   arraysize
      ...
      Changed in version 3.14.1: Negative values are rejected by
      raising "ValueError".
