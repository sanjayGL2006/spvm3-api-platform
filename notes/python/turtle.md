...
"distance(start) < 1" is a good way to know when the turtle is back at
its start position.
...
turtle.addshape(name, shape=None)
   ...
   Changed in version 3.14: Added support for PNG, PGM, and PPM image
...
exception turtle.TurtleGraphicsError
   ...
   Raised for invalid arguments or operations. For example, a
...
|==========================|================================|========================================|
| "bytedesign"             | complex classical turtle       | "tracer()", "delay()", "update()"      |
|                          | graphics pattern               |                                        |
+--------------------------+--------------------------------+----------------------------------------+
...
+--------------------------+--------------------------------+----------------------------------------+
| "clock"                  | analog clock showing time of   | turtles as clock's hands, "ontimer()"  |
|                          | your computer                  |                                        |
+--------------------------+--------------------------------+----------------------------------------+
...
|                          |                                | ("shape()", "shapesize()")             |
+--------------------------+--------------------------------+----------------------------------------+
| "nim"                    | play the classical nim game    | turtles as nimsticks, event driven     |
|                          | with three heaps of sticks     | (mouse, keyboard)                      |
...
+--------------------------+--------------------------------+----------------------------------------+
| "sorting_animate"        | visual demonstration of        | simple alignment, randomization        |
