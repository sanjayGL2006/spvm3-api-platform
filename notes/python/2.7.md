...
technical details involved. The recommended starting point is the How
to port Python 2 Code to Python 3 HOWTO guide.
...
useful for implementers of Python interpreters and to users who wish
...
* New function: "PySys_SetArgvEx()" sets the value of "sys.argv" and
  ...
  *updatepath* set to false.
  ...
  Security issue reported as **CVE 2008-5983**; discussed in bpo-5753,
...
* The "os.kill()" function now works on Windows.  The signal value can
  ...
  The first two constants will send "Control"-"C" and
  "Control"-"Break" keystroke events to subprocesses; any other value
  will use the "TerminateProcess()" API.  (Contributed by Miki Tebeka;
  bpo-1220212.)
...
As **discussed in the PEP**, platform packagers may choose not to
install these commands by default, as long as, when invoked, they
provide clear and simple directions on how to install them on that
platform (usually using the system package manager).
...
versions of those guides remaining available as Building C and C++
Extensions with setuptools and Building C and C++ Extensions with
setuptools.
