...
Changed in version 3.10: **PEP 644** has been implemented. The ssl
...
ssl.create_default_context(purpose=Purpose.SERVER_AUTH, *, cafile=None, capath=None, cadata=None)
   ...
   *capath* or *cadata* is given) or uses
   ...
   Changed in version 3.13: The context now uses
...
TLSVersion.TLSv1_3
   ...
   Deprecated since version 3.10: All "TLSVersion" members except
...
class ssl.SSLSocket(socket.socket)
   ...
   * "shutdown()"
   ...
   Changed in version 3.7: "SSLSocket" instances must be created with
...
class ssl.SSLContext(protocol=None)
   ...
   Deprecated since version 3.10: "SSLContext" without protocol
...
SSLContext.wrap_socket(sock, server_side=False, do_handshake_on_connect=True, suppress_ragged_eofs=True, server_hostname=None, session=None)
   ...
   *session*, see "session".
   ...
   Changed in version 3.7: The method returns an instance of
...
class ssl.SSLObject
   ...
   * All IO on an "SSLObject" is non-blocking. This means that for
   ...
   Changed in version 3.7: "SSLObject" instances must be created with
