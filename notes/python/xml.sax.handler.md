...
xml.sax.handler.feature_namespace_prefixes
   ...
   The parser based on "xml.parsers.expat" does not support this
   feature.
...
xml.sax.handler.feature_validation
   ...
   The parser based on "xml.parsers.expat" does not support this
   feature, because Expat is a non-validating parser.
...
xml.sax.handler.property_declaration_handler
   ...
   No parser in the standard library supports this property, and the
   standard library provides no such handler.
...
xml.sax.handler.property_interning_dict
      ...
      "feature_string_interning" feature.
      access: read/write
...
with the property identifier "'http://xml.org/sax/properties/lexical-
handler'".
