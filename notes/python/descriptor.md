...
hardwired in the *LoggedAgeAccess* class.  That means that each
...
The function has a *qualified name* attribute to support
introspection:
...
If you have ever wondered where *self* comes from in regular methods
or where *cls* comes from in class methods, this is it!
...
At this point, the metaclass has loaded member objects for *x* and
*y*:
