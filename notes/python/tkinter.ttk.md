...
|                  | view in the widget's window changes, the widget calls the |
|                  | *xscrollcommand* callback.  Usually this option consists  |
|                  | of the method "Scrollbar.set" of some scrollbar. This     |
|                  | will cause the scrollbar to be updated whenever the view  |
...
|                  | headings", that is, show all elements.  **Note**: Column |
|                  | #0 always refers to the tree column, even if show="tree" |
|                  | is not specified.                                        |
+------------------+----------------------------------------------------------+
...
class tkinter.ttk.Style
   ...
   map(style, query_opt=None, **kw)
      ...
      *style*.
      ...
      Changed in version 3.10: The value returned when querying the
      map was corrected.
...
class tkinter.ttk.Scale(master=None, **kw)
   ...
   configure(cnf=None, **kw)
      ...
      Changed in version 3.9: Now returns the configuration value,
