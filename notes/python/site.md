...
site.getsitepackages(prefixes=None)
   ...
   is "None"), this function will compute its site-packages
   subdirectory depending on the system environment, and will return a
   list of full paths, which are not checked for existence.

   Added in version 3.2.

   Changed in version 3.3: Added the optional *prefixes* parameter.
