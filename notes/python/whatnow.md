...
* Python built-ins reference: gives details about Python's built-in
  types and functions.

* The Python standard library: gives complete (though terse) reference
  material about types, functions, and the modules in the standard
  library.  The standard Python distribution includes a *lot* of
