...
+---------------------------+---------------------------+---------------------------+---------------------------+
| ctypes type               | C type                    | Python type               | "_type_"                  |
|===========================|===========================|===========================|===========================|
| "c_bool"                  | _Bool                     | "bool"                    | "'?'"                     |
+---------------------------+---------------------------+---------------------------+---------------------------+
...
+---------------------------+---------------------------+---------------------------+---------------------------+
| "c_char_p"                | char* (NUL terminated)    | "bytes" or "None"         | "'z'"                     |
+---------------------------+---------------------------+---------------------------+---------------------------+
| "c_wchar_p"               | wchar_t* (NUL terminated) | "str" or "None"           | "'Z'"                     |
+---------------------------+---------------------------+---------------------------+---------------------------+
...
class ctypes.CDLL(name, mode=DEFAULT_MODE, handle=None, use_errno=False, use_last_error=False, winmode=None)
   ...
   *mode* is ignored.  On posix systems, RTLD_NOW is always added, and
   is not configurable.
   ...
   Changed in version 3.12: The *name* parameter can now be a *path-
   like object*.
...
ctypes.POINTER(type, /)
   ...
   **CPython implementation detail:** The resulting pointer type is
   cached in the "__pointer_type__" attribute of *type*. It is
...
class ctypes._SimpleCData
   ...
   _type_
      ...
      single-character string. See Fundamental data types for a
      summary.
