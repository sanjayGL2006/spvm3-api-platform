...
exception calendar.IllegalMonthError(month)
   ...
   Changed in version 3.12: "IllegalMonthError" is now also a subclass
   of "ValueError". New code should avoid catching "IndexError".
...
Changed in version 3.14: By default, today's date is highlighted in
color and can be controlled using environment variables.
