...
class complex(real=0, imag=0)
   ...
   Deprecated since version 3.14: Passing a complex number as the
...
class dict(iterable, /, **kwargs)
   ...
   class. See also Mapping Types --- dict for documentation about this
   class.
...
class frozenset(iterable=(), /)
   ...
   from *iterable*.  "frozenset" is a built-in class.  See also Set
...
locals()
   ...
   Changed in version 3.13: As part of **PEP 667**, the semantics of
...
open(file, mode='r', buffering=-1, encoding=None, errors=None, newline=None, closefd=True, opener=None)
   ...
   * If the system call is interrupted and the signal handler does not
     raise an exception, the function now retries the system call
     instead of raising an "InterruptedError" exception (see **PEP
...
class set(iterable=(), /)
   ...
   *iterable*.  "set" is a built-in class.  See also Set Types ---
...
class slice(start, stop, step=None, /)
   ...
   *iterator*.
   ...
   Changed in version 3.12: Slice objects are now *hashable* (provided
...
sum(iterable, /, start=0)
   ...
   Changed in version 3.14: Added specialization for summation of
...
class super(type, object_or_type=None, /)
   ...
   *type* will be the enclosing class, and *obj* will be the first
   ...
   Changed in version 3.14: "super" objects are now "pickleable" and
   "copyable".
...
class type(name, bases, dict, /, **kwargs)
   ...
   *metaclass*) would.
   ...
   the metaclass "__prepare__" method (see Preparing the class
   namespace).  Use "types.new_class()" to dynamically create a class
   using the appropriate metaclass.
