...
- for example, as described in User-defined objects. However, these
...
* *formatters* - the corresponding value will be a dict in which each
  ...
  which correspond to the arguments passed to create a "Formatter"
  object:
  ...
  * "defaults" (since version >=3.12)
  ...
  are as for "Formatter", thus this key is most useful for
  instantiating a customised subclass of "Formatter".  For example,
  the alternative class might present exception tracebacks in an
  expanded or condensed format.  If your formatter requires different
  or extra configuration keys, you should use User-defined objects.
...
* *handlers* - the corresponding value will be a dict in which each
  ...
  * "filters" (optional).  A list of ids of the filters for this
    ...
    Changed in version 3.11: "filters" can take filter instances in
    addition to ids.
