...
class tempfile.TemporaryDirectory(suffix=None, prefix=None, dir=None, ignore_cleanup_errors=False, *, delete=True)
   ...
   *context manager* (see Examples).  On completion of the context or
...
tempfile.mkdtemp(suffix=None, prefix=None, dir=None)
   ...
   Changed in version 3.12: "mkdtemp()" now always returns an absolute
...
tempfile.gettempdir()
   ...
   4. A platform-specific location:
      ...
      * On Windows, the directories
        "%USERPROFILE%\AppData\Local\Temp", "%SYSTEMROOT%\Temp",
