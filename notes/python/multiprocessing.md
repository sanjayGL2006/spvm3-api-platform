...
start a process.  These *start methods* are
   ...
   *forkserver*
      ...
      Changed in version 3.14: This became the default start method on
      POSIX platforms.
...
Changed in version 3.14: On POSIX platforms the default start method
was changed from *fork* to *forkserver* to retain the performance but
avoid common multithreaded process incompatibilities. See gh-84559.
   ...
   *kwargs* is a dictionary of keyword arguments for the target
   ...
   Note:
     ...
     *target* must have been defined within an importable module in
     ...
     Contexts and start methods. See also gh-132898.
   ...
   run()
      ...
      *kwargs* arguments, respectively.
      ...
      Using a list or tuple as the *args* argument passed to "Process"
...
multiprocessing.cpu_count()
   ...
   using the "-X cpu_count" flag or "PYTHON_CPU_COUNT" as this is
   merely a wrapper around the "os" cpu count APIs.
...
class multiprocessing.pool.Pool([processes[, initializer[, initargs[, maxtasksperchild[, context]]]]])
   ...
   *context* can be used to specify the context used for starting the
   ...
   Changed in version 3.13: *processes* uses "os.process_cpu_count()"
