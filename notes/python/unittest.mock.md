...
class unittest.mock.Mock(spec=None, side_effect=None, return_value=DEFAULT, wraps=None, name=None, spec_set=None, unsafe=False, **kwargs)
   ...
   * *unsafe*: By default, accessing any attribute whose name starts
...
class unittest.mock.AsyncMock(spec=None, side_effect=None, return_value=DEFAULT, wraps=None, name=None, spec_set=None, unsafe=False, **kwargs)
   ...
   * if "side_effect" is an iterable, the async function will return
     ...
     result is *exhausted*, "StopAsyncIteration" is raised
     immediately,
...
cause a value to be obtained from the successors. Instead,
