...
gc.collect(generation=2)
   ...
   *generation* may be an integer specifying which generation to
   ...
   Changed in version 3.14: "generation=1" performs an increment of
   collection.

   Changed in version 3.14.5: "generation=1" performs collection of
...
gc.get_objects(generation=None)
   ...
   Changed in version 3.14.5: Generation 1 is reintroduced to maintain
   GC behavior from 3.13.
...
gc.set_threshold(threshold0[, threshold1[, threshold2]])
   ...
   Changed in version 3.14.5: *threshold2* is restored to match Python
   3.13 behavior.
