...
Changed in version 3.14: The "-P" command-line option and the
...
BINARY_OP(op)
   ...
   Changed in version 3.14: With oparg :"NB_SUBSCR", implements binary
...
FOR_ITER(delta)
   ...
   below it).  If the iterator indicates it is *exhausted* then the
...
SET_FUNCTION_ATTRIBUTE(flag)
   ...
   * "0x10" the *annotate function* for the function object
   ...
   Changed in version 3.14: Added "0x10" to indicate the annotate
