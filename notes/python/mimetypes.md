...
class mimetypes.MimeTypes(filenames=(), strict=True)
   ...
   The initial database is created from Python's built-in MIME type
   tables. It may be extended by loading additional "mime.types"-style
   files into the database using the "read()" or "readfp()" methods.
   ...
   suffix_map
      ...
      to be recognized separately. This is initialized with some
      predefined values.
   ...
   types_map
      ...
      initialized with some predefined values and MIME type
      information loaded from files specified by the *filenames*
      argument.
