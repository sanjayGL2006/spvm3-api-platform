...
class http.server.SimpleHTTPRequestHandler(request, client_address, server, directory=None)
   ...
   Changed in version 3.9: The *directory* parameter accepts a *path-
   like object*.
   ...
   extensions_map
      ...
      Changed in version 3.9: This dictionary is no longer filled with
   ...
   guess_type(path)
      ...
      Changed in version 3.13: Add "mimetypes.guess_file_type()" as a
      fallback.
...
Changed in version 3.12: Control characters are scrubbed in stderr
logs.
